        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    complaint_count = table.Column<string>(type: "text", nullable: true),
                    suggestion_count = table.Column<string>(type: "text", nullable: true),
                    pizza_order_count = table.Column<string>(type: "text", nullable: true),
                    drink_order_count = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Complaints_AspNetUsers_AspNetUsersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Suggestions_AspNetUsers_AspNetUsersId",
                        column: x => x.AspNetUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    AspNetUsersId = table.Column<string>(type: "text", nullable: false),
                    DrinksModelDrinkName = table.Column<string>(type: "text", nullable: true),
                    DrinksModelFinalPrice = table.Column<int>(type: "integer", nullable: false),
                    DrinksModelId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DrinkOrders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DrinkOrders_AspNetUsers_AspNetUsersId",
                        column: x => x.AspNetUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DrinkOrders_Drinks_DrinksModelId",
                        column: x => x.DrinksModelId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PizzasModelId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Complaints_AspNetUsersId",
                table: "Complaints",
                column: "AspNetUsersId");

            migrationBuilder.CreateIndex(
                name: "IX_DrinkOrders_AspNetUsersId",
                table: "DrinkOrders",
                column: "AspNetUsersId");

            migrationBuilder.CreateIndex(
                name: "IX_DrinkOrders_DrinksModelId",
                table: "DrinkOrders",
                column: "DrinksModelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Suggestions_AspNetUsersId",
                table: "Suggestions",
                column: "AspNetUsersId");
        }
